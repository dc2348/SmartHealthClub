...
public class SubPage02Activity extends Activity {
	...
	private final String SERVER_ADDRESS = "http://192.168.43.28/icebreaking/butterfly_tab";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mainLayout = (LinearLayout)findViewById(R.id.sub02Layout);
				...
				handler.post(new Runnable() {
					...
					public void run() {
						...
						try {
							...
							String[] wdata1 = weight1.split("\n"); 
							String[] wdata2 = weight2.split("\n"); 
							String[] wdata3 = weight3.split("\n"); 
							String[] wdata4 = weight4.split("\n"); 
							String[] wdata5 = weight5.split("\n"); 
							String[] wdata6 = weight6.split("\n"); 
							String[] wdata7 = weight7.split("\n"); 
							...
							getWeight1 = Integer.parseInt(wdata1[0]);
							getCounting1 = Integer.parseInt(cdata1[0]);
							getWeight2 = Integer.parseInt(wdata2[0]);
							getCounting2 = Integer.parseInt(cdata2[0]);
							getWeight3 = Integer.parseInt(wdata3[0]);
							getCounting3 = Integer.parseInt(cdata3[0]);
							getWeight4 = Integer.parseInt(wdata4[0]);
							getCounting4 = Integer.parseInt(cdata4[0]);
							getWeight5 = Integer.parseInt(wdata5[0]);
							getCounting5 = Integer.parseInt(cdata5[0]);
							getWeight6 = Integer.parseInt(wdata6[0]);
							getCounting6 = Integer.parseInt(cdata6[0]);
							getWeight7 = Integer.parseInt(wdata7[0]);
							getCounting7 = Integer.parseInt(cdata7[0]);
							
							// 아이템 추가
							addItem("2013/12/12  "+wdata1[0]+"kg", getCounting1);
					        addItem("2013/12/13  "+wdata2[0]+"kg", getCounting2);
					        addItem("2013/12/14  "+wdata3[0]+"kg", getCounting3);
					        addItem("2013/12/15  "+wdata4[0]+"kg", getCounting4);
					        addItem("2013/12/16  "+wdata5[0]+"kg", getCounting5);
					        addItem("2013/12/17  "+wdata6[0]+"kg", getCounting6);
					        addItem("2013/12/18  "+wdata7[0]+"kg", getCounting7);
