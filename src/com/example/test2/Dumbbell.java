...
public class Dumbbell extends Activity {
	public static final String TAG = "Dumbbell";
	...
	int Minute=0;
	int Hour=0;
	String dumbbellCount="0";
	int dumbbellWeight=5;
	...
	private final String SERVER_ADDRESS = "http://192.168.43.28/icebreaking/dumbbell_user";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dumbbell);
        ...
        Intent targetIntent = new Intent(this, Dumbbell.class);
    ...
    private int showTag(NdefMessage mMessage) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if(newMachine.equals("treadmill")){
            	Toast.makeText(getApplicationContext(), "먼저 Dumbbell 운동을 종료해주세요", Toast.LENGTH_LONG).show();
	...
	protected void Update() {
		...
		Runnable updater = new Runnable() {
			public void run() {
				...
				mCount.setText(dumbbellCount);
				mWeight.setText(""+ dumbbellWeight+" kg");
			}
		};
	...
	public void searchData(){
		...
		try {
			...
			String counting = getXmlData("searchresult.xml",
					"counting");// name 태그값을 읽어 namelist 리스트에 저장

			dumbbellCount = "" + counting;
